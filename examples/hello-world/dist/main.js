...
function main(_ref) {
    ...
    var notifications$ = _rx2.default.Observable.interval(10000).startWith(-1).map(function (value) {
        return {
        ...
        all$ = _rx2.default.Observable.merge(show$, click$, error$, close$);
...
var drivers = {
    notification: (0, _lib.makeNotificationDriver)()
};

_core2.default.run(main, drivers);

},{"../../../lib":5,"@cycle/core":1,"rx":3}],5:[function(require,module,exports){
"use strict";
...
},{"./notification-driver":6}],6:[function(require,module,exports){
'use strict';
...
},{"rx":7}],7:[function(require,module,exports){
